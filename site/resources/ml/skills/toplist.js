document.addEventListener('DOMContentLoaded', function() {
    const toplistApiURL = '/api/v2/ml/skill-toplist';
    let toplistData = [];
    let currentPage = 1;
    let totalPages = 0;
    ...
    function createToplistRow(item) {
        ...
        accuracyCell.textContent = item.Metrics['Mean Accuracy'].toFixed(2); // Format to 3 decimal places
        ...
        minigameCell.innerHTML = `${getSkillImage(item.minigame)}`;
